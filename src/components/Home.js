...
const Home = ({ toggle, setToggle }) => {
  ...
  return (
    <div>
      API CONTENT IN UI,
      simialrly create a API and images link in it.
      <ul>
        {hotels.map((hotel) => (
          <li key={hotel.id}>
            <h3>{hotel.title}</h3>
          ...
          <div className="flex justify-end items-center relative">
            <div className="flex mr-4 items-center">
              ...
              <div className="block relative">
                <button
                  type="button"
                  className="inline-block py-2 hover:bg-gray-200 rounded-full relative "
                >
              ...
              <div className="inline relative">
                {
                  ...
                  >
                    ...
                    {userimage.length > 2 ? (
                      <img src={userimage} className="UserLoginImage ml-5" />
                    ) : (
